...
═══ FINDINGS THE AI GOT WRONG (FALSE POSITIVES — REJECTED) ═══
${rejectedBlock}

═══ FINDINGS THE AI CORRECTLY IDENTIFIED (PROTECTED — DO NOT SUPPRESS) ═══
${confirmedBlock}
...
FOR FALSE POSITIVES:
- Ask: what evidence made the AI think something was wrong when it wasn't?
- Write a narrow conditional to avoid that specific confusion — not a broad suppression
- Rules that say "never flag X" are almost always wrong — make them "only flag X if Y"
