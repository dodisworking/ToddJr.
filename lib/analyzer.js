 ...
 */
export async function analyzeTenant(tenant, files, onProgress) {
  return _orchestrateAnalysis(tenant, files, onProgress, analyzeFolder)
}
 ...
 */
export async function gymAnalyzeTenant(tenant, files, onProgress) {
  return _orchestrateAnalysis(tenant, files, onProgress, gymAnalyzeFolder)
}
 ...
 */
export async function beefedUpAnalyzeTenant(tenant, files, onProgress, learnings = []) {
  return _orchestrateAnalysis(tenant, files, onProgress,
    (t, pdfs, txts, gaps, batchInfo) => beefedUpAnalyzeFolder(t, pdfs, txts, gaps, batchInfo, learnings)
  )
}

// ── shared orchestration (DRY) ────────────────────────────────────────────────

async function _orchestrateAnalysis(tenant, files, onProgress, analyzeFolder_fn) {
