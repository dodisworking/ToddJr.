 ...
 */
export async function evaluateSideBySide({ rawResult, beefedResult, activeLearnings, tenantName }) {
 ...
 */
export async function extractLearningsFromDrTodd(reportText, tenantName) {
 ...
 */
export async function compileWorkoutFeedback({ tenant, findings, feedbacks, annotations }) {
