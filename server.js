...
// ── Gantt Chart AI Generation ────────────────────────────────────────────────
app.post('/api/gantt/ai-generate', express.json(), async (req, res) => {
  ...
  if (!anthropicKey && !openaiKey) {
    return res.status(500).json({ error: 'No AI API key configured. Set ANTHROPIC_API_KEY or OPENAI_API_KEY in .env' })
  }
